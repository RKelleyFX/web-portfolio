...
const initialChildState = { age: '', gender: '', activity: '', learnAge: '' }

function OFMSurvChild() {
    const [contact, setContact] = useState([]);
    const [formData, setFormData] = useState(initialChildState);
                                ...
                                <Card.Body>
                                    <Form>
                                        <Form.Group controlId="exampleForm.ControlTextarea1">
                                            ...
                                            <Form.Control as="textarea" rows="1" onChange={e => setFormData({ ...formData, 'age': e.target.value })} value={formData.age} />
                                        </Form.Group>
